...
// NOTE: sendMail di-import secara lazy di dalam fungsi untuk avoid webpack bundling di client-side
...
export const createWorkspace = async (creatorId, email, name, slug) => {
  ...
  // Dynamic import untuk avoid bundling nodemailer di client-side
